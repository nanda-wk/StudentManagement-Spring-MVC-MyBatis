...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="BUD003.jsp">Class Registration</a></li>';
    html = html +'<li><a href="BUD001.jsp?flag=1">Student Search</a></li>';
    html = html +'<li><a href="StudentRegisterServlet">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="usermanagement" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
